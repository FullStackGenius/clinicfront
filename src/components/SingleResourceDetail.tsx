                ...
                <div className="main-container">
                    ...
                    <div className="blog-items">
                        <div className="blog-content-image">
                            <div className="blog-featured-image">
                                <div className="featured-div">
                                    <a href="#"><img className="img-fluid" src="/assets/images/blog-featured-image.png" alt="" title=""/></a>
                                </div>
                                <div className="blog-category">
                                    <span>eBook</span>
                                </div>
                            ...
                            <div className="blog-content-info">
                                <h3><a href="#">How to design a that can grow itself year</a></h3>
                                <p>Understanding color theory: the color wheel and finding complementary colors</p>
                            </div>
                        </div>
                        <div className="blog-meta-info">
                            <div className="blog-date">
                            ...
                            <div className="learn-more-btns">
                                <a href="#"><span className="link-texts d-flex align-items-center"><span className="name-text">Learn More</span> <img className="img-fluid" src="/assets/images/learn-more-icon.svg" alt="" title=""/></span></a>
                            </div>
                        </div>
                    </div>
                    <div className="blog-items">

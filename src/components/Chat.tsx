...
function Chat() {
   ...
   // const fetchChatData = async (userId = 0) => {
   //    try {
   //       setLoading(true);
   //       let urlPath = userId > 0 ? `chat/start/${userId}` : 'chat/start';
   //       const response = await axiosInstance.get(urlPath);
   //       setChatPartner(response.data.chatPartners);
   //       setChatMessage(response.data.messages);
   //       setCurrentChatUser(response.data.currentChatUser);
   ...
   // useEffect(() => {
   //    const fetchMessages = () => {
   //       fetchChatData(segmentId ? Number(segmentId) : undefined);
   //    };
   //    fetchMessages();
                                       ...
                                       <div className="top-chat-content">
                                          <header className="up-chat-header chat-header">
                                             ...
                                             <div className="chat-start-call">
                                                ...
                                                <div className="more-messages-options" onClick={() => navigate("/")}>
                                                   <span className="air3-icon"><img className="img-fluid" src="/assets/images/more-icons.svg" alt="" title="" /></span>
                                                   <span className="air3-icon"><img className="img-fluid" src="/assets/images/back-icon.svg" alt="" title="" /></span>
                                                </div>
                                             </div> */}
                                          </header>
                                                                        ...
                                                                        <div className="chat-story-section">
                                                                           <div className="chat-story-message">
                                                                              <div className="chat-up-message">
                                                                                 <p>{message.message}</p>
                                                                                 {/* Ensure file_type is a string before checking its value */}

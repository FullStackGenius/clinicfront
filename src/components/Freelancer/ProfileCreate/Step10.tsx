		...
		try {
			...
			if(user_details){
				...
				setFormData({...formData,  
					...
					country: response.data.details.country_id, 
				});
		...
		<Layout backButton={true} pagetitle="" currentStep={10} issubmitting={submitting} getStarted={saveData}>
		   <div className="air-wiz-body">
			  <div className="air-carousel-items">
				 <div id="step-item-10" className="air-step-items">
					<div className="step-title-container">
					   <h2>A few last details then you can check and publish your profile</h2>
					</div>
					<div className="file-location-step">
					   <div className="file-grid-container">
						  <div className="span-colm-3">
							 <div className="portrait-uploader-boxs">
								<div className="profile-uploader">
									<button className="fe-upload-btn upload-btn">
										<div className="air-illustration avatar-image">
											{!preview ? (
												<>
												{preprofileimage === '' ? (
												<img className="img-fluid" src="/assets/images/sasheen-m-img.png" />
												) : (
													<img className="img-fluid" src={preprofileimage} />
												)}
												</>
											) : (
												<img src={preview} />
										...
										<span className="upload-icons" onClick={() => setImageModal(true)}><img className="img-fluid" src="/assets/images/white-small-icon.svg" alt="" title="" /></span>
									</button>
								</div>
							 </div>
						  </div>
						  <div className="span-colm-9">
							 <div className="profile-forms-items">
								<div className="form-grid-container">
								   ...
								   <div className="phone-grid-row">
										...
										{/*<div className="send-code-btns">
										 <div className="form-group">
											<button className="btn-send-primary" data-test="send-code" type="button" data-ev-label="send_code">Send Code</button>
										</div>
									  </div>*/}
								   </div>
								</div>

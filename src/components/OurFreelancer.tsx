            ...
            <div className="main-projects">
               <div className="project-filter-bar">
                  <div className="filter-blocks">
                     <div className="pr-filter-boxs">
                        <div className="filter-time d-flex align-items-center" onClick={() => setJobType('full-time')}>
							{jobtype === 'full-time' ? (
								<img className="img-fluid" src="/assets/images/orange-check-circle-icon.svg" alt="" title="" />
							) : (
                     ...
                     <div className="pr-filter-boxs">
                        <div className="freelance-filter-block d-flex align-items-center" onClick={() => setJobType('part-time')}>
							{jobtype === 'part-time' ? (
								<img className="img-fluid" src="/assets/images/orange-check-circle-icon.svg" alt="" title="" />
							) : (
								<img className="img-fluid" src="/assets/images/check-circle-icon.svg" alt="" title="" />
                     ...
                     <div className="newest-filter-block">
					 ...
					 <div className="pr-filter-boxs">
                        <div className="freelance-filter-block d-flex align-items-center" onClick={handleClearFilters}>
											   ...
											   <div className="project-infos">
												  ...
												  <div className="pr-content">
													 <div className="pr-profile">
														<img className="img-fluid" src={item.profile_image_path} alt="" title="" />
													 </div>
													 ...
													 <div className="pr-user-rating d-flex align-items-center justify-content-center">
														<div className="pr-rating-icon">
														   <img className="img-fluid" src="/assets/images/small-star-icon.svg" alt="" title="" />
														</div>

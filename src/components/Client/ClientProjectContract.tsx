...
function ClientProjectContract() {
                    ...
                    <div className="main-container">
                        ...
                        <div className="jobs-tab-items">
                            ...
                            <div className="tab-card-section">
                                {activeTab === "all" &&
                                    <ContractComponent getPagination={getPagination} lastPage={lastPage} handlePageChange={handlePageChange} currentPage={currentPage} contracts={contracts} contractPageFor="client" />
                                   }
                                {activeTab === "active" && <ContractComponent getPagination={getPagination} lastPage={lastPage} handlePageChange={handlePageChange} currentPage={currentPage} contracts={contracts} contractPageFor="client" />
                                    }
                                     {activeTab === "pending" && <ContractComponent getPagination={getPagination} lastPage={lastPage} handlePageChange={handlePageChange} currentPage={currentPage} contracts={contracts} contractPageFor="client" />
                                    }
                                {activeTab === "completed" && 
                                   <ContractComponent getPagination={getPagination} lastPage={lastPage} handlePageChange={handlePageChange} currentPage={currentPage} contracts={contracts} contractPageFor="client" />
                                }
...
export default ClientProjectContract